...
//chama o método que valida os campos da tela.
    ...
    public void montaComboPessoa() {
        listaPessoas = HibernateUtil.getSession().createQuery("from Pessoa order by nome").list();
        cPessoa.removeAllItems();
        for (Pessoa est : listaPessoas) {
            cPessoa.addItem(est.getNome());
        }
    }
...
// caso a operação seja novo, os campos se comportam diferente, por exemplo, os campos da tela serão habilitados, e os botões de salvar e cancelar também.
    ...
    private void initComponents() {
        ...
        cPessoa = new javax.swing.JComboBox<>();
        ...
        cPessoa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cPessoa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cPessoaActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cPessoa, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(16, 16, 16)
                                .addComponent(cTotal)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(cPessoa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(cTotal))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        venda.setPessoa(listaPessoas.get(cPessoa.getSelectedIndex()));
...
//pega o atributo sigla do objeto e seta o texto do campo sigla da interface
        cPessoa.setSelectedItem(venda.getPessoa().getNome());
...
// chama o método valida campos para o perfil novo.
    ...
    private void btAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddActionPerformed
        ...
        itensVenda.setPreco(Double.parseDouble(cPreco.getText()));
        itensVenda.setQuantidade(Double.parseDouble(cQuantidade.getText()));
        itensVenda.setCusto(itensVenda.getProduto().getCusto());
        ...
        if ((estoque - itensVenda.getQuantidade()) < 0) {
            ...
            cTotal.setText("R$ " + venda.getTotal());
        }
        // TODO add your handling code here:
    ...
    private void cProdutoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cProdutoItemStateChanged
        if (cProduto.getSelectedItem() != null) {
            cPreco.setText(listaProdutos.get(
    ...
    private void cPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cPessoaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cPessoaActionPerformed
    ...
    public void montaTabela() {
        ...
        for (Venda ve : listaVendas) {
            modelo.addRow(new Object[]{ve.getId(), ve.getDataVenda(), ve.getPessoa().getNome(), ve.getTotal()});
        }
    ...
    private javax.swing.JComboBox<String> cPessoa;
