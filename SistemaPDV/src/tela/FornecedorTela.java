...
public class FornecedorTela extends javax.swing.JDialog {
    ...
    public FornecedorTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//chama o método que vai montar a tabela de fornecedors e exibir os fornecedors salvos no banco.
        montaTabela();
//chama o método que valida os campos da tela.
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(cCnpj)
                                            .addComponent(cTelefone, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(17, 17, 17)
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        fornecedor.setNome(cNome.getText());
        fornecedor.setCnpj(cCnpj.getText());
        fornecedor.setTelefone(cTelefone.getText());
        fornecedor.setEndereco(cEndereco.getText());
        fornecedor.setNumero(cNumero.getText());
        fornecedor.setCidade(listaCidades.get(cCidade.getSelectedIndex()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        fornecedor = listaFornecedores.get(tabela.getSelectedRow());
        cCodigo.setText(fornecedor.getId().toString());
        cNome.setText(fornecedor.getNome());
        cCnpj.setText(fornecedor.getCnpj());
        cTelefone.setText(fornecedor.getTelefone());
        cEndereco.setText(fornecedor.getEndereco());
        cNumero.setText(fornecedor.getNumero());
        cCidade.setSelectedItem(fornecedor.getCidade().getNome());
...
// chama o método valida campos para o perfil novo.
    ...
    public void montaTabela() {
        Query q = HibernateUtil.getSession().createQuery("from Fornecedor where (lower(nome) like :filtro "
                + "or lower(cnpj) like :filtro "
        ...
        for (Fornecedor pe : listaFornecedores) {
