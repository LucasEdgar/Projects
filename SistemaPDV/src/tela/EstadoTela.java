...
//classe que cria a tela do cadastro de estado.
public class EstadoTela extends javax.swing.JDialog {
    
//instanciando um objeto estado para ser manipulado e persistido no banco de dados
    private Estado estado = new Estado();
//lista de estados para exibir na tela todos os estados salvos.
    private List<Estado> listaEstados = new ArrayList<>();

    /**
     * Creates new form EstadoTela
     */
//metodo construtor, pois ele tem o mesmo nome da classe.
    public EstadoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//chama o método que vai montar a tabela de estados e exibir os estados salvos no banco.
        montaTabela();
...
// Método salvar, vai persistir ou alterar um estado no banco de dados.
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
//Recupera o texto digitado pelo usuário no campo nome da interface, e seta no atributo nome do objeto estado.
        estado.setNome(cNome.getText());
//Recupera o texto digitado pelo usuário no campo sigla da interface, e seta no atributo sigla do objeto estado.
        estado.setSigla(cSigla.getText());
        
//chama a classe do hibernate e inicia uma nova transação com o banco.
        HibernateUtil.beginTransaction();
//recupera uma sessão do banco e executa um MERGE do objeto estado.
...
//Chama o método que limpa os campos da interface.
        limparCampos();
//chama o método que monta a tabela para trazer o estado que acabou de ser salvo. Atualiza a tabela da interface.
        montaTabela();
...
//instancia um novo objeto estado para ser salvo no banco de dados.
        estado = new Estado();
...
//método que é disparado quando o usuário clica em uma linha da tabela de estados.
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
// pega o index da linha selecionada da tabela, e passa por parametro para recuperar um objeto da lista de estados, este objeto é atribuído ao objeto estado global.       
...
// o objeto estado já esta selecionado, ou seja já existe o objeto para ser excluido.
// inicia uma nova transação com o banco de dados
        HibernateUtil.beginTransaction();
//executa um delete do objeto estado selecionado.
...
//chama o método que limpa os campos da tela
        limparCampos();
//        estado = new Estado();
// chama o método monta tabela que vai atualizar a tabela sem o estado deletado.
        montaTabela();
...
//método que monta a tabela da interface que lista todos os estados salvos no banco de dados.
    public void montaTabela() {
// utiliza do hibernate para consultar no banco de dados todos os estados salvos, e atribui este resultado na lista de estados global.        
...
// laço de repetição que percorre cada estado da lista de estados
        for (Estado est : listaEstados) {
//para cada estado é adicionado um nova linha na tabela em memória.
